...
import 'consts/datawedge_api_targets.dart';
import 'consts/datawedge_event_type.dart';
import 'consts/empty_command.dart';
import 'consts/method_channel_methods.dart';
import 'consts/scanner_control_states.dart';
import 'consts/scanner_plugin_command.dart';
import 'consts/value_enum.dart';
...
class FlutterDataWedge {
  ...
  final EventChannel _eventChannel = const EventChannel('channels/scan');
  final MethodChannel _methodChannel = const MethodChannel('channels/command');
  ...
  Future<void> initialize({String? commandIdentifier}) async {
    final String identifier = commandIdentifier ?? const Uuid().v4();
  ...
  Future<Result<void, FlutterDatawedgeException>> _sendDataWedgeCommand(
    ...
    try {
      ...
      final identifier = commandIdentifier ?? const Uuid().v4();
